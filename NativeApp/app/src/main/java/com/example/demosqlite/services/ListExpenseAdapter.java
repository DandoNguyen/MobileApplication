...
public class ListExpenseAdapter extends ArrayAdapter<ExpenseModel> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        tv_expenseType.setText(expenseModel.getExpenseType());
        tv_expenseAmount.setText(String.valueOf(expenseModel.getExpenseAmount()));
        tv_expenseComment.setText(expenseModel.getExpenseComment());

        tv_expenseTime.setText(customDate(expenseModel.getExpenseTime()));
